...
class ListaControllerTest < ActionController::TestCase
  ...
  test "should create listum" do
    assert_difference('Listum.count') do
      post :create, listum: { descripcion: @listum.descripcion, nombre: @listum.nombre, preciobtc: @listum.preciobtc, preciomxn: @listum.preciomxn }
    end
  ...
  test "should update listum" do
    patch :update, id: @listum, listum: { descripcion: @listum.descripcion, nombre: @listum.nombre, preciobtc: @listum.preciobtc, preciomxn: @listum.preciomxn }
    assert_redirected_to listum_path(assigns(:listum))
  end
